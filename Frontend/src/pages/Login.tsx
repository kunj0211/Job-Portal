    ...
    <div className="min-h-screen flex items-center justify-center bg-slate-50 p-4">
      ...
      >
        ...
        <div className="mt-8 flex items-center justify-center space-x-4">
          ...
          <span className="text-slate-400 text-xs font-bold uppercase tracking-wider">or join with</span>
          <div className="h-px flex-1 bg-slate-100"></div>
        </div>
        ...
        <p className="mt-8 text-center text-slate-500 text-sm">
          New here?{' '}
          <Link to="/signup" className="text-emerald-600 hover:text-emerald-700 font-bold transition-colors underline-offset-4 hover:underline">
            Create an account
          </Link>
        </p>
      </div>
