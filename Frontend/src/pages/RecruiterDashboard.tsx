...
const RecruiterDashboard = () => {
	...
	const { stats, recentApplicants } = useMemo(() => {
		let totalApps = 0
		let pending = 0
		let accepted = 0
		let rejected = 0
			...
			if (job.applicants) {
				...
				job.applicants.forEach((app: any) => {
					...
					allApplicants.push({
						...
						candidateName: app.name || app.candidateName,
						jobTitle: job.title,
		...
		return {
			...
			recentApplicants: allApplicants.slice(0, 5),
		}
	}, [jobs, applications])
				...
				>
					...
					<div className='grid grid-cols-1 lg:grid-cols-3 gap-8'>
						...
						<div className='space-y-6'>
							...
							<motion.div
								variants={itemVariants}
								className='bg-linear-to-br from-emerald-600 to-teal-800 rounded-3xl p-6 text-white shadow-lg shadow-emerald-900/20 relative overflow-hidden'
							>
								...
								<p className='text-emerald-100 text-sm font-medium mb-6 relative z-10 leading-relaxed'>
									...
									increases your hire rate by 30%.
								</p>
								<button
									onClick={() =>
										navigate('/recruiter/applications')
